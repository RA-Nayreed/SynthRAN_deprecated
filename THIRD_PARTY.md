...
|---|---|---|---|---|
| `RA-Nayreed/5g-Ansible` | SLICES provider context and 5G infrastructure authority | `71025e88326732dcf592e99a8c07c700704650ac` | External detached checkout at `.deps/5g_ansible-r2lab`; invoked only through `bin/fiveg` | `NOASSERTION` in the SynthRAN lock; do not copy or redistribute upstream source without reviewing its own repository |
